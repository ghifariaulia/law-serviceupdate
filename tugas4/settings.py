...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-#yb#8*@dnh9&!$4&l+@vyom!004e$#ibvr1#aq9^5^z$a8%arr')
...
WSGI_APPLICATION = 'tugas4.wsgi.application'
